...
public class EasyRuler extends View {
    ...
    public EasyRuler(Context context) {
        this(context, null);

    }

    public EasyRuler(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EasyRuler(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.EasyRuler);

        mAlphaEnable = typedArray.getBoolean(R.styleable.EasyRuler_alphaEnable, mAlphaEnable);

        mLineSpaceWidth = typedArray.getDimension(R.styleable.EasyRuler_lineSpaceWidth, mLineSpaceWidth);
        mLineWidth = typedArray.getDimension(R.styleable.EasyRuler_lineWidth, mLineWidth);
        mLineMaxHeight = typedArray.getDimension(R.styleable.EasyRuler_lineMaxHeight, mLineMaxHeight);
        mLineMidHeight = typedArray.getDimension(R.styleable.EasyRuler_lineMidHeight, mLineMidHeight);
        mLineMinHeight = typedArray.getDimension(R.styleable.EasyRuler_lineMinHeight, mLineMinHeight);
        mLineColor = typedArray.getColor(R.styleable.EasyRuler_lineColor, mLineColor);

        mTextSize = typedArray.getDimension(R.styleable.EasyRuler_textSize,  mTextSize);
        mTextColor = typedArray.getColor(R.styleable.EasyRuler_textColor, mTextColor);
        mTextMarginTop = typedArray.getDimension(R.styleable.EasyRuler_textMarginTop, mTextMarginTop);

        mSelectorValue = typedArray.getFloat(R.styleable.EasyRuler_selectorValue, 0.0f);
        mMinValue = typedArray.getFloat(R.styleable.EasyRuler_minValue, 0.0f);
        mMaxValue = typedArray.getFloat(R.styleable.EasyRuler_maxValue, 100.0f);
        mPerValue = typedArray.getFloat(R.styleable.EasyRuler_perValue, 0.1f);
